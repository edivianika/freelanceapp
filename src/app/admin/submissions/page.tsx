                  ...
                  <tr key={submission.id}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{typeof submission.project_interest === 'string' ? submission.project_interest : submission.project_interest?.name || 'Unknown Project'}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
